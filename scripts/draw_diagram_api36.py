...
plt.plot(time_steps, cpu_flutter, label='Flutter', linestyle='-')
plt.plot(time_steps, cpu_android, label='Kotlin + XML View', linestyle='-')
plt.plot(time_steps, cpu_compose, label='Kotlin + Jetpack Compose', linestyle='-')
...
plt.plot(time_steps, ram_flutter, label='Flutter', linestyle='-')
plt.plot(time_steps, ram_android, label='Kotlin + XML View', linestyle='-')
plt.plot(time_steps, ram_compose, label='Kotlin + Jetpack Compose', linestyle='-')
...
plt.bar(battery_labels, battery_usage_values, color=['#1f77b4', '#ff7f0e', '#2ca02c'])
...
plt.bar(battery_labels, avg_cpu_usage, color=['#1f77b4', '#ff7f0e', '#2ca02c'])
...
plt.bar(battery_labels, avg_ram_usage, color=['#1f77b4', '#ff7f0e', '#2ca02c'])
